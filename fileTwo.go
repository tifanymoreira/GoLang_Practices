...
var nome string = "Mundo" // || nome := [FAZENDO DESSA FORMA, A VARIÁVEL É DECLARADA E O SEU TIPO INFERIDO]
    fmt.Println("Olá, " + nome + "!") //Println é a função exportada da biblioteca fmt previamente importada.

	// OU => fmt.Println("Olá,", nome, "!")
}